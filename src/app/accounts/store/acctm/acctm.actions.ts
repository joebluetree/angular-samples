...
export const load_success = createAction(
  prefix + 'Load Success',
  props<{ records: iAcctm[], page: iPage, row_type: string }>()
);
...
export const update_search = createAction(
  ...
  props<{ search_record: iAcctm_Search, row_type: string }>()
);

export const upsert_row = createAction(
  prefix + 'Add / Update Row',
  props<{ record: iAcctm, row_type: string }>()
);
