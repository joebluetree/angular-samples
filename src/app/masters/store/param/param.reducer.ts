...
export const initialState: ParamState = adapter.getInitialState({
  selectid: 0,
...
export const paramReducer = createReducer<ParamState>(
  initialState,
...
export const paramFeature = createFeatureSelector<ParamState>(paramFeatureName);
